...
synifyInjectivityAnn :: Maybe Name -> [TyVar] -> Maybe [Bool]
                     -> Maybe (LInjectivityAnn Name)
synifyInjectivityAnn Nothing _ _ = Nothing
synifyInjectivityAnn _ _ Nothing = Nothing
synifyInjectivityAnn (Just lhs) tvs (Just inj) =
