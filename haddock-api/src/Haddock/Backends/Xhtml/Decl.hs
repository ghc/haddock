...
ppShortConstrParts summary dataInst con unicode qual
  = case con of
      ...
      ConDeclGADT {} ->
          ( hsep [ ppOcc, dcolon unicode, ppLType unicode qual HideEmptyContexts (getGADTConTypeDni con) ]
          , noHtml
          , noHtml
          )
...
ppSideBySideConstr subdocs fixities unicode qual (L _ con)
 ...
 where
    ...
    decl = case con of
      ...
      ConDeclGADT{}
          ...
          | otherwise -> hsep [ ppOcc
                              ...
                              , ppLType unicode qual HideEmptyContexts (getGADTConTypeDni con)
                              , fixity
                              ]
    ...
    doConstrArgsWithDocs args = subFields qual $ case con of
      ...
      ConDeclGADT{} ->
        ppSubSigLike unicode qual (unLoc (getGADTConTypeDni con))
